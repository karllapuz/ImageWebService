    ...
    <section class="category">
                            ...
                            <?php
                                if(isset($_SESSION["cart"]))
                                {
                                    foreach($_SESSION["cart"] as $product)
                                    {
                                        ...
                                        <div class='three wide column middle aligned content'>
                                            <a href='food.php?action=remove&imageID=$imageID' class='ui negative icon button'>
        ...
        <div class="pusher">
                ...
                <div class="ui large secondary menu">
                    ...
                    <div class="ui dropdown item">
                        ...
                        <div class="menu">
                            ...
                            <a href="food.php"class="active item">Food</a>
                    ...
                    <div class="right menu">
                        ...
                        <form method="post" action="food.php" class="ui item">
            ...
            <div id="top-segment" class="ui center aligned container">
                ...
                <div class="ui raised attached segment">
                    <div class="ui four center aligned doubling stackable container cards">
                        ...
                        <?php 
                            $imagesQuery = "SELECT * FROM imageInfo WHERE category = 'food' ORDER BY purchases DESC;";
                            ...
                            if(!empty($images)) {
                                ...
                                for ($x = 0; $x < 4; $x++) {
                                    ...
                                    ?>
                                    <form method="post" action="food.php?action=add&imageID=<?php echo $imageID ?>" class="ui column raised card">
            ...
            <div class="ui four center aligned doubling stackable container cards">
                ...
                <?php 
                    // for ($i = 1; $i <= 16; $i++) { 
                    $imageProduct = query("SELECT * FROM imageInfo WHERE category = 'food';");
                    if(!empty($imageProduct)) {
                        foreach($imageProduct as $key => $value) {
                            ...
                            if ($purchases > 1) $purchaseString = "Purchases";
                ?>
                        <form method="post" action="food.php?action=add&imageID=<?php echo $imageProduct[$key]["imageID"]?>" class="ui column raised card">
                            <div class="ui blurring dimmable image">
                                <div class="ui dimmer">
                                    <div class="content">
                                        <div class="center">
