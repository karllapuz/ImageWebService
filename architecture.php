            ...
            <div id="top-segment" class="ui center aligned container">
                ...
                <div class="ui raised attached segment">
                    <div class="ui four center aligned doubling stackable container cards">
                        ...
                        <?php 
                            $imagesQuery = "SELECT * FROM imageInfo WHERE category = 'architecture' ORDER BY purchases DESC;";
                            ...
                            if(!empty($images)) {
                                ...
                                for ($x = 0; $x < 4; $x++) {
                                    ...
                                    ?>
                                    <form method="post" action="architecture.php?action=add&imageID=<?php echo $imageID ?>" class="ui column raised card">
