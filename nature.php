                            ...
                            <?php
                                if(isset($_SESSION["cart"]))
                                {
                                    foreach($_SESSION["cart"] as $product)
                                    {
                                        ...
                                        <div class='three wide column middle aligned content'>
                                            <a href='nature.php?action=remove&imageID=$imageID' class='ui negative icon button'>
                ...
                <?php 
                    ...
                    if(!empty($imageProduct)) {
                        foreach($imageProduct as $key => $value) {
                            ...
                            if ($purchases > 1) $purchaseString = "Purchases";
                ?>
                        <form method="post" action="nature.php?action=add&imageID=<?php echo $imageProduct[$key]["imageID"]?>" class="ui column raised card">
                            <div class="ui blurring dimmable image">
                                <div class="ui dimmer">
                                    <div class="content">
                                        <div class="center">
